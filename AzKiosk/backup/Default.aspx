...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="GraphControls">
    ...
    <div id="main-input-container" style="float: left; margin-right: 20px;">
        <!-- Nav tabs -->
        ...
        <div class="tab-content">
            <div class="tab-pane input-pane active" id="policyPane" role="tabpanel" style="position: relative;">
                <div class="chart-controls" id="flow-controls">
                    ...
                    <div>
                        <div id="policy-consumer-controls" style="float: left;">
                            <span class="policy-title">Water Use</span>
                        </div>
                ...
                <div id="climate-controls" style="float: left;">
                    ...
                    <%--<div id="DSCNInputUserControl_controlgroup" class="realclearfix controlgroup" style="display: block;">
                        ...
                        <div id="DSCNInputUserControl_buttonset" class="radio-container-climate" style="float: left;">
                            ...
                            <input type="radio" id="DSCNInputUserControl_radio_2" name="DSCNInputUserControl_radio" value="2" /><label class="input-button-2" for="DSCNInputUserControl_radio_2">Moderate</label>
    ...
    <div id="main-output-container" style="float: left;">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link custom-nav-link active" data-toggle="tab" id="flowDiagram-tab" name="#flowDiagram" role="tab">Flow Chart</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content" style="float: left;">
            <div class="tab-pane active" id="flowDiagram" role="tabpanel" style="position: relative;">
                ...
                <div class="chart" style="display: inline-block; height: 500px; margin-top: 35px;">
        ...
        <div class="assessment">
            ...
            <div class="assessment-indicator" data-fld="EVIND_P">
            ...
            <div class="assessment-indicator" data-fld="ECOR_P">
                <svg viewBox="400 400 40 40">
            ...
            <div class="assessment-indicator" data-fld="GWSYA_P">
                <svg viewBox="400 400 40 40">
            ...
            <div class="assessment-indicator" data-fld="UEF_P">
                <svg viewBox="400 400 40 40">
            ...
            <div class="assessment-indicator" data-fld="AGIND_P">
                <svg viewBox="400 400 40 40">
            ...
            <div class="assessment-indicator" data-fld="IEF_P">
                <svg viewBox="400 400 40 40">
            ...
            <div class="assessment-indicator" data-fld="PEF_P">
                <svg viewBox="400 400 40 40">
