...
function SetRunButtonWaiting() {
    $("*.run-model").each(function () {
        console.log('Commented out: SetRunButtonWaiting');
        //this.style.backgroundColor = ReadyColor;
        //this.style.border = "2px solid " + this.style.backgroundColor + " !important";
        var btn = $(this);
...
function SetRunButtonDone() {
    $("*.run-model").each(function () {
        ...
        btn.addClass('done');
        console.log('Commented out: SetRunButtonDone');
    });
...
function SetRunButtonRunning() {
    $("*.run-model").each(function () {
        ...
        console.log('Commented out: SetRunButtonRunning');
    });
}
//$("*.run-model").each(function () {
